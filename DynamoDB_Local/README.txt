...
新しいPCで開発環境整える時は、DynamoDB_Localのためにダミーの aws configure が必要。
（もしかすると無くてもコードの側からアクセスキーとシークレットキーを指定するだけで問題なく動いたかもしれないが）。

なおM1 Macでも動かせるように、下記の記事を参照にトラブルシューティングを行った
http://taint.org/2022/02/09/183535a.html
